                ...
                <div className="navbar bg-base-200 shadow-md sticky top-0 z-50">
                    ...
                    <div className="flex-none gap-4 items-center">
                        <div className="hidden md:block">
                            <Link to="/" className="btn btn-outline btn-sm mx-2 items-center gap-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                            ...
                            <Link to="/connections" className="btn btn-outline btn-sm mx-2 items-center gap-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                            ...
                            <Link to="/requests" className="btn btn-outline btn-sm mx-2 items-center gap-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
